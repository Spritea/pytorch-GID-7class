...
def test(args,cfg):
    ...
    for j in tqdm(range(len(IMG_Str))):
        ...
        out_path="test_out/data06-CAN50/"+Path(img_path).name
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default="pretrain/data06/mv3_res50_my_best_model.pkl",
    ...
    parser.add_argument(
        ...
        default="dataset/06_train38_v2/val", help="Path of the input image"
    )
    parser.add_argument(
        "--out_path",
        nargs="?",
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default="configs/mv3_1_true_2_res50_GID_data06.yml",
